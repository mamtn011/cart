    ...
    "1iaGP": [
      function (require, module, exports) {
        ...
        class Cart {
          #incrementCart;
          #getProduct(id) {
            return (0, _uiJsDefault.default).protucts.find(
          ...
          #setIncrementCart() {
            if (localStorage.getItem("myCartProducts")) {
              const storage = JSON.parse(
                localStorage.getItem("myCartProducts")
              );
              this.#incrementCart = storage.length;
            } else this.#incrementCart = 0;
          }
          #getDomElm() {
            const { productsGridElm, cartCountElm, cartIcon } = (0,
            _uiJsDefault.default).selectDomElm();
            return {
              productsGridElm,
              cartCountElm,
              cartIcon,
          ...
          init() {
            const { productsGridElm, cartCountElm, cartIcon } =
              this.#getDomElm();
